...
public class SpatialHashGrid {
    ...
    public int[] getCellIds(GameObject obj) {
        int x1 = (int)FloatMath.floor(obj.bounds.getLowerLeft().x / cellSize);
        int y1 = (int)FloatMath.floor(obj.bounds.getLowerLeft().y / cellSize);
        int x2 = (int)FloatMath.floor((obj.bounds.getLowerLeft().x + obj.bounds.getWidth()) / cellSize);
        int y2 = (int)FloatMath.floor((obj.bounds.getLowerLeft().y + obj.bounds.getHeight()) / cellSize);
