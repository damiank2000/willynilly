...
public class SpatialHashGrid {
    ...
    public int[] getCellIds(GameObject obj) {
        int x1 = (int)Math.floor(obj.bounds.getLowerLeft().x / cellSize);
        int y1 = (int)Math.floor(obj.bounds.getLowerLeft().y / cellSize);
        int x2 = (int)Math.floor((obj.bounds.getLowerLeft().x + obj.bounds.getWidth()) / cellSize);
        int y2 = (int)Math.floor((obj.bounds.getLowerLeft().y + obj.bounds.getHeight()) / cellSize);
